#!/usr/bin/env python3
"""
Generated MCP Server for Документация Ozon Performance API

This file was automatically generated by swagger-mcp-server
from the Swagger specification: swagger-openapi-data/swagger.json

Generated on: 2025-09-27T00:57:51.856257
API Version: 2.0
"""
...
class OzonPerformanceApiMCPServer:
    """Generated MCP Server for Документация Ozon Performance API."""
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        base_config = {
            "api_title": "Документация Ozon Performance API",
            "api_version": "2.0",
            "server_name": "-ozon-performance-api",
            "host": "localhost",
            "port": 8080,
            "database_path": "./test-mcp-server/data/mcp_server.db",
            "search_index_path": "./test-mcp-server/data/search_index",
        }
...
async def main():
    """Main entry point."""
    server = OzonPerformanceApiMCPServer()
    await server.start()
