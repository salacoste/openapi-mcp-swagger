...
class TestEnhancedGetSchema:
    ...
    def test_component_name_normalization(self, server):
        ...
        # Complex names
        assert server._normalize_component_name("#/components/schemas/User.Profile") == "User.Profile"
    ...
    async def test_response_format_compliance(self, server):
        ...
        schema = result["schema"]
        schema_fields = ["name", "type", "properties", "description", "required"]
        ...
        metadata = result["metadata"]
        metadata_fields = [
            "component_name", "normalized_name", "resolution_depth",
            "total_dependencies", "circular_references", "max_depth_reached",
            "resolution_settings"
        ]
        ...
        settings_fields = [
            "resolve_dependencies", "max_depth", "include_examples", "include_extensions"
        ]
