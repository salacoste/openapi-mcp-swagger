...
class TestSystemCompatibilityChecker:
    ...
    @pytest.mark.asyncio
    async def test_check_network_connectivity_available(self, checker):
        """Test network connectivity check with available connection."""
        ...
        assert "Network connectivity available" in result["message"]

    @pytest.mark.asyncio
    async def test_check_network_connectivity_unavailable(self, checker):
    ...
    @pytest.mark.asyncio
    async def test_check_network_connectivity_timeout(self, checker):
