    ...
    def test_get_endpoint_statistics(self):
        ...
        endpoints = [
            ...
            Mock(
                ...
                security=[Mock()],
                responses={"201": Mock()},
                schema_dependencies=set(["User", "CreateUser"]),
                security_dependencies=set(["bearerAuth"]),
            ),
        ]
...
class TestSecurityMapper:
    ...
    def test_normalize_api_key_scheme(self):
        ...
        schemes, errors, warnings = self.mapper.normalize_security_schemes(
            components_data
        )
    ...
    def test_validate_security_consistency(self):
        ...
        schemes = {
            ...
            "oauth2": Mock(
                ...
                oauth2_flows={
                    "authorization_code": Mock(scopes={"read": "Read access"})
                },
            ),
        }
...
class TestSearchOptimizer:
    ...
    def test_get_search_statistics(self):
        ...
        documents = [
            ...
            SearchableDocument(
                "2", "schema", "User", "user schema object", ["user"], {}, 1.0
            ),
        ]
...
class TestIntegrationTests:
    ...
    def test_complete_normalization_pipeline(self):
        ...
        (
            ...
            endpoint_errors,
            endpoint_warnings,
        ) = self.endpoint_normalizer.normalize_endpoints(openapi_data["paths"])
        ...
        (
            ...
            schema_errors,
            schema_warnings,
        ) = self.schema_processor.process_schemas(
        ...
        ) = self.consistency_validator.validate_full_consistency(
            endpoints, schemas, security_schemes
        )
    ...
    def test_performance_with_large_dataset(self):
        ...
        (
            ...
            errors,
            warnings,
        ) = self.endpoint_normalizer.normalize_endpoints(paths_data)
