...
rm ./mcp-server-tmp5all7atv/data/mcp_server.db
python server.py
```
...
rm -rf ./mcp-server-tmp5all7atv/data/search_index
python server.py
```
...
- **Original Swagger file**: `/var/folders/zn/q3v0th8s0918bl7_p1xmd2l00000gn/T/tmp5all7atv.json`
