...
rm ./mcp-server-tmpur4mfrxf/data/mcp_server.db
python server.py
```
...
rm -rf ./mcp-server-tmpur4mfrxf/data/search_index
python server.py
```
...
- **Original Swagger file**: `/var/folders/zn/q3v0th8s0918bl7_p1xmd2l00000gn/T/tmpur4mfrxf.json`
